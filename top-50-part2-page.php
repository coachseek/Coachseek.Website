<?php
/*
Template Name: Top 50 Part 2 Page Template
* Version: 1.0
*/
?>
<!DOCTYPE html>
            ...
            <div class="row--full">
               ...
               <div class="col-9-12 landing--header-nav">
                   ...
                   <ul class="landing--header-nav-list">
                       ...
                       <li><a class="landing--header-signin" href="https://app.coachseek.com/#/new-user-setup" onClick="ga('send', 'event', { eventCategory: 'FreeTrial', eventAction: 'click', eventLabel: 'SignUpButton'});">Join us!</a></li>
                   </ul>
               </div>               
            </div>
    </header>
      ...
      <?php if( get_field('quote-image') ): ?>
       ...
       <?php endif; ?>
           ...
           <div class="row--full" style="text-align:center;padding-right:15%;padding-left:15%;">
               ...
               <p style="width:100%;padding-bottom:50px;line-height: 1.5;"><?php the_field('quote-name'); ?></p>
           </div>
       </div>
