    ...
    <header>
      ...
      <?php 
              if(isset($_POST['submit'])){
                  ...
                  echo "<p class='feedback' style='position:relative;background:#00A578;text-align:center; color:white; font-size:14px;'>Your Register Webinar has been sent, see you soon!</p>";
                  ?>
                  <style type="text/css">
       ...
       <div class="landing--home-bg webinar" style="background: url('<?php the_field('webinar-home-background'); ?>') 0 0px no-repeat; background-size: cover;">
          <div class="landing--home-bg-overlap"></div>
           <div class="row--full">
              ...
              <div class="col-6-12">
                <form method="post" name="webinar" id="webinar-form" action=""  target="_blank">     
                  <div class="row--full">
                      <div class="row--full">
                      ...
                      <button id="webinar-submit" type="submit" name="submit">Watch Webinar</button>
                  </div>
              </form>
              </div>
           </div>
